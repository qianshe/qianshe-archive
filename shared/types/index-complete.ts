...
export namespace QiansheTypes {
  ...
  export namespace Utils {
    export type Cache = import('./utils-extended').Cache;
    export type EventEmitter = import('./utils-extended').EventEmitter;
    export type State = import('./utils-extended').State;
    export type Config = import('./utils-extended').Config;
    export type Logger = import('./utils-extended').Logger;
  }
}
...
// 高级工具类型使用
import type { Cache, EventEmitter, Logger } from './types';
...
const emitter = createEventEmitter<{ message: string; data: any }>();
const logger = new BaseLogger('my-app', 'info');
*/